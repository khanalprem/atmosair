...
$(document).ready(function () {
	...
	// 	"lng": 83.44836
	//   }];
	customPopup = '<div class="bind-popup"> <div class="bind-header"><h5>Western Cape College</h5> <a href="project-details.html" class="openSpace_btn">See More</a></div><ul><li></li><li></li></ul>'
	var customOptions =
	{
		popupAnchor: [-10, -10],
		'maxWidth': '400',
